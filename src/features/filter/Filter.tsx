...
import type { DateListType, TextTypeList, LanguageListType, ModeListType, DateFilter } from "./types";
...
const languageList: LanguageListType = [
  ...
  { value: "en", label: "history.filter.language.english" },
  { value: "uk", label: "history.filter.language.ukrainian" },
];
