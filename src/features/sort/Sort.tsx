...
export const Sort = () => {
  ...
  return (
    <div className="sort-container">
      <SortSelect options={sortOptions} currentOption={currentSortBy} onChange={handleSortChange} />
      <button
      ...
      >
        <Icon width={24} height={24} icon={currentSortOrder === "asc" ? "arrow-up-icon" : "arrow-down-icon"} />
      </button>
    </div>
  );
};
